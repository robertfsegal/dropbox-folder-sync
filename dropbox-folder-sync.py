#
# Derived from Dropbox SDK example https://github.com/dropbox/dropbox-sdk-python/blob/master/example/updown.py
#
...
parser = argparse.ArgumentParser(description='Sync current folder to Dropbox')
